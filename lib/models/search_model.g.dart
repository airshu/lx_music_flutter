...
SearchMusicModel _$SearchMusicModelFromJson(Map<String, dynamic> json) =>
    SearchMusicModel(
...
Map<String, dynamic> _$SearchMusicModelToJson(SearchMusicModel instance) =>
    <String, dynamic>{
      'list': instance.list,
...
SearchListModel _$SearchListModelFromJson(Map<String, dynamic> json) =>
    SearchListModel(
      list: (json['list'] as List<dynamic>?)
              ?.map((e) => SearchListItem.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
...
SearchListItem _$SearchListItemFromJson(Map<String, dynamic> json) =>
    SearchListItem(
      name: json['name'] as String? ?? '',
      source: json['source'] as String? ?? '',
      img: json['img'] as String? ?? '',
...
Map<String, dynamic> _$SearchListItemToJson(SearchListItem instance) =>
    <String, dynamic>{
